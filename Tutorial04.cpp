...
const int gridSize = 15 + 1; //Can be edited
//int vertexSize;
//int indicesSize;
...
HRESULT InitDevice()
{
    ...
    //    { XMFLOAT3(0.7f, 0.0f, 0.7f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    //    { XMFLOAT3(-0.7f, 0.0f, 0.7f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    ...
    //    //Hexagonal Upper Base
    //    { XMFLOAT3(0.0f, 1.5f, 0.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    //    { XMFLOAT3(0.7f, 1.5f, 0.7f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    //    { XMFLOAT3(-0.7f, 1.5f, 0.7f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    //    { XMFLOAT3(1.0f, 1.5f, 0.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    //    { XMFLOAT3(-1.0f, 1.5f, 0.0f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    //    { XMFLOAT3(-0.7f, 1.5f, -0.7f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    //    { XMFLOAT3(0.7f, 1.5f, -0.7f), XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f) },
    ...
    //create list of vertices in the grid
   /* SimpleVertex vertices[gridSize * gridSize];
    ...
    for (int i = 0; i < gridSize; i++)
    {
        for (int j = 0; j < gridSize; j++)
        {
            ...
            vertices[k] = { XMFLOAT3(float(i), r, float(j)), XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f) };
            k++;
        }
    }*/
    //For Grid--------------------------------------------------------------------------------------------------------------------
    ...
    vertexSize = sizeof(SimpleVertex) * mesh_vertices.size();
    indicesSize = sizeof(SimpleVertex) * mesh_indices.size();

    D3D11_BUFFER_DESC bd = {};
    bd.Usage = D3D11_USAGE_DEFAULT;
    // bd.ByteWidth = sizeof(SimpleVertex) * (gridSize * gridSize);
    ...
    //For Grid--------------------------------------------------------------------------------------------------------------------
    /*const int sizeofindices = gridSize * gridSize * 2 * 3;
    WORD indices[sizeofindices];
    int index = 0;
    k = 0;
    for (int i = 0; i < gridSize - 1; i++)
    {
        for (int j = 0; j < gridSize - 1; j++)
        {
            ...
            indices[k] = index + 1;
            k++;
            indices[k] = index + gridSize;
            k++;
            indices[k] = index + 1;
            k++;
            indices[k] = index + gridSize;
            k++;
            indices[k] = index + gridSize + 1;
            k++;
            index++;
        }
        index++;
    ...
    bd.Usage = D3D11_USAGE_DEFAULT;
    //bd.ByteWidth = sizeof( WORD ) * sizeofindices;        // 36 vertices needed for 12 triangles in a triangle list
    ...
    XMVECTOR Eye = XMVectorSet(0.f, 12.0f, 3.0f, 0.0f);
    XMVECTOR At = XMVectorSet(4.0f, 0.0f, 0.0f, 0.0f);
    XMVECTOR Up = XMVectorSet(0.0f, 1.0f, 0.0f, 0.0f);
...
void Render()
{
    ...
    g_pImmediateContext->DrawIndexed(indicesSize, 0, 0);   // 36 vertices needed for 12 triangles in a triangle list
